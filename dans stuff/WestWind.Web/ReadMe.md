...
- [Additional Notes](#additional-notes)
  - [Multiple Projects in VS 2019](#multiple-projects-in-vs-2019)
  - [Paginator (*Revamped*)](#paginator-revamped)
    - [Usage](#usage)

## Multiple Projects in VS 2019
...
To instantiate the Paginator, you should use the following pattern.
...
To use the Paginator in your .cshtml markup, use the following approach.
...
@{
    foreach(var pageRef in Model.Revamp)
    {
        ...
        {
            <a title="Page @pageRef.Page" asp-page="/AdHoc" asp-route-currentpage="@pageRef.Page">@pageRef.Text</a>
        }
    }
}
```
